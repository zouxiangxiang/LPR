...
namespace prc{
    ...
    public:
        ...
        PlateSegmentation(){}
        void segmentPlatePipline(PlateInfo_ &plateInfo,int stride,std::vector<cv::Rect> &Char_rects);
        ...
        void ExtractRegions(PlateInfo_ &plateInfo,std::vector<cv::Rect> &rects);
