...
namespace prc{
    ...
    public:
        ...
        void plateDetectionRough(cv::Mat InputImage,std::vector<prc::PlateInfo_>  &plateInfos,int min_w=36,int max_w=800);
		//void plateDetectionRough_(cv::Mat InputImage, std::vector<pr::PlateInfo>  &plateInfos, int min_w = 36, int max_w = 800);
