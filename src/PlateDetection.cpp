...
namespace prc{
    ...
    void PlateDetection::plateDetectionRough(cv::Mat InputImage,std::vector<prc::PlateInfo_>  &plateInfos,int min_w,int max_w){
        cv::Mat processImage;
        ...
        for(auto plate:platesRegions)
        {
            ...
            PlateInfo_ plateInfo(plateImage,plate);
