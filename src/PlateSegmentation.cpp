...
//    }
    ...
    void PlateSegmentation::segmentPlatePipline(PlateInfo_ &plateInfo,int stride,std::vector<cv::Rect> &Char_rects){
...
//        cv::waitKey(0);
    ...
    void PlateSegmentation::ExtractRegions(PlateInfo_ &plateInfo,std::vector<cv::Rect> &rects){
